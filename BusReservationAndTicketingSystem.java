...
public class BusReservationAndTicketingSystem {
	...
	public static void main(String args[]) throws IOException {
		...
		for (int i = 1; i < 4;) {
			...
			if (user.equals("Sai Bhargav") && password.equals("Sai@9903")) {
				...
				for (int x = 1; x == 1;) {
					...
					for (x = 1; x == 1;) {
						...
						if (choice.equals("1")) {
							...
							System.out.println("******************************************");
							System.out.println("** 1.)HYDERABAD       |   $16  |   " + available[1] + "   **");
							System.out.println("** 2.)CHENNAI         |   $21  |   " + available[2] + "   **");
							System.out.println("** 3.)BANGLORE        |   $17  |   " + available[3] + "   **");
							System.out.println("** 4.)CHOUTUPPAL      |   $20  |   " + available[4] + "   **");
							System.out.println("** 5.)JADCHERLA       |   $22  |   " + available[5] + "   **");
							System.out.println("******************************************");
							System.out.println("******************************************\n");
							...
							if ((available[1] == 0) && (available[2] == 0) && (available[3] == 0) && (available[4] == 0)
								...
								String dest[] = { " ", "HYDERABAD", "CHENNAI", "BANGLORE", "CHOUTUPPAL", "JADCHERLA" };
								...
								for (x = 1; x == 1;) {
									System.out.print("HOW MANY PASSENGERS YOU ARE?: ");
